...
# added to support being ran without X server
import os
import time

# code added to use the frame buffer ( run from the command line )

disp_no = os.getenv( "SDL_VIDEODRIVER" )
if disp_no:
	print "I'm running under X display = {0}".format( disp_no )

# check for the appropriate driver (  digg using aalib for later (..) )
